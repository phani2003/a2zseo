...
<html>
  <head>
    <meta charset="UTF-8">
    <title>AtoZ SEO Tools v2 | Installer panel</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="logo">
          ...
          <span class="logo-lg">AtoZ <b>SEO</b> Tools<sup>v2</sup></span>
        </a>
    ...
    <br />  
     ...
     <!-- Main Footer -->
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="https://prothemes.biz/">ProThemes.Biz</a></strong> All rights reserved.
      </footer>
